...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'kb_mash'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from kb_mash.kb_mashImpl import kb_mash  # noqa @IgnorePep8
impl_kb_mash = kb_mash(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'kb_mash'
        ...
        self.rpc_service.add(impl_kb_mash.run_mash_dist_search,
